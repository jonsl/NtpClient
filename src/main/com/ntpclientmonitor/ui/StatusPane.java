...
class StatusPane extends GridPane {
    ...
    StatusPane() {
        ...
        ObservableList<TableColumn<PeerRow, String>> columnList = FXCollections.observableArrayList();

        final String columnStyle = "-fx-alignment:center-right; -fx-padding: 2px; -fx-font-size:12px;";

        TableColumn<PeerRow, String> selectCol = new TableColumn<>("select");
        columnList.add(selectCol);
        selectCol.setStyle("-fx-alignment:center");
        selectCol.setSortable(false);
        selectCol.setPrefWidth(30);
        selectCol.setMinWidth(30);
        selectCol.setCellValueFactory(new PropertyValueFactory<PeerRow, String>("select"));
        TableColumn<PeerRow, String> remoteCol = new TableColumn<>("remote");
        columnList.add(remoteCol);
